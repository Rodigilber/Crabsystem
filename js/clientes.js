...
// Triggered when 	..\modal\registro_clientes.php  is submitted 
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
		//getting vals from Responsive table, some of them are hidden generated by buscar.php
		...
		//seting vals to modal edit form
			...
			var array = obligaciones_fisc_cliente.split(',');
			array.forEach( function(element){
				$("#"+element+"_checkbox").prop('checked', true);
			} );
