...
while ($row=mysqli_fetch_array($sql))
	{
		...
		$precio_venta=$row['precio_tmp'];   //=  "precio_venta_"  taken from #Mymodal 

													//"INSERT INTO detalle_factura VALUES ('','$numero_factura','$id_producto','$cantidad','$precio_venta_r')");

		$precio_venta_f=number_format($precio_venta,2);//Formateo variables
		$precio_venta_r=str_replace(",","",$precio_venta_f);//Reemplazo las comas
		$precio_total=$precio_venta_r*$cantidad;

		$precio_total_f=number_format($precio_total,2);	//Precio total formateado CAntidad por precio
	    ...
	    if (!mysqli_query($con,"INSERT INTO detalle_factura(numero_factura,id_producto,cantidad,precio_venta) VALUES ('$numero_factura','$id_producto','$cantidad','$precio_venta_r')")) {
	        printf("Error: %s\n", mysqli_error($con));
	    }			
	...
	//Below field will be ignored due the client request
...
$insert=mysqli_query($con,"INSERT INTO facturas VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','1','$total_factura')");
