<?php
	...
	if($action == 'ajax'){
		...
		$sWhere   = "Select * From tblobligaciones ";
		// Columnas a buscar dentro de la tabla de regimenes
		$aColumns = array('claveobligacion','obligacion');
...
?>
			...
			<?php
					...
					while ($row=mysqli_fetch_array($query)) {
						$idRegimen    = $row["idobligacion"];
						$clave        = $row["claveobligacion"];
						$descripcion  = $row["obligacion"];
			?>
