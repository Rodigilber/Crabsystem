...
<?php
	...
	$update=mysqli_query($con,"update facturas set total_venta='$subtotal' where id_factura='$id_factura'");
?>
<!--
		<tr>
		...
		<tr>
			<td class='text-right' colspan=4>IVA, remove it (<?php echo $impuesto;?>)% <?php echo $simbolo_moneda;?></td>
...
<tr>
	...
	<td class='text-right'><?php echo number_format($subtotal,2);?></td><!--wil be substituded by subtotal>
	<td></td>
</tr>
