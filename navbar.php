  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="<?php echo $active_facturas;?>"><a href="facturas.php"><i class='glyphicon glyphicon-list-alt'></i> Recibos <span class="sr-only">(current)</span></a></li>

        <li class="<?php echo $active_productos;?>"><a href="productos.php"><i class='glyphicon glyphicon-barcode'></i> Conceptos</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="TBD" target='_blank'><i class='glyphicon glyphicon-envelope'></i> Soporte</a></li>
