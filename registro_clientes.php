		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="datepicker1" name="initservprof" required>
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="datepicker2" name="finservprof" required>
				</div>
			  </div>
...
<!--
				...
				<div class="col-sm-8">
				 <select class="form-control" id="regfiscal" name="regfiscal" required>
...
-->
				...
				<label for="regfiscal" class="col-sm-3 control-label">RÉGIMEN FISCAL</label>
				<div class="col-sm-8">
				  <input type="checkbox" name="regfiscal[]" value="RIF" />RIF<br />
				  <input type="checkbox" name="regfiscal[]" value="PF con Activ. Emp. y Prof." />PF con Activ. Emp. y Prof.<br />
				  <input type="checkbox" name="regfiscal[]" value="Régimen de Arrendamiento" />Régimen de Arrendamiento<br />
				  <input type="checkbox" name="regfiscal[]" value="Sector Primario" />Sector Primario<br />
				  <input type="checkbox" name="regfiscal[]" value="Reg. De Sueldos y Salarios" />Reg. De Sueldos y Salarios<br />		 
				</div>
			  </div>
...
<!--
				...
				<div class="col-sm-8">
				 <select class="form-control" id="obfiscales" name="obfiscales" required>
					<option value="" selected>-- Selecciona una opcion --</option>
...
-->
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="contrdrfc" name="contrdrfc" required>
				</div>
			  </div>
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="contrefirma" name="contrefirma" required>
				</div>
			  </div>
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="datepicker3" name="expefirma" required>
				</div>
			  </div>
