<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Factura | ControlSys";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i>Editar pago</h4>
		</div>
		...
		?>
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal">
						 <span class="glyphicon glyphicon-search"></span> Agregar cargo
						</button>
			...
			<div class="clearfix"></div>
				...
				<div id="resultados" class='col-md-12' style="margin-top:10px"></div>	<!-- Carga los datos ajax , usando  editar_factura.js-->			
